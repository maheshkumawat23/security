app.controller('adminController', function ($scope, $http, $ionicPopup, $ionicLoading,$state) {
  ...
  $scope.sync = function () {
    ...
    if ($scope.feedbackData.length === 0) {
      ...
      $http.post('https://stark-lowlands-52608.herokuapp.com/api/posts', $scope.feedbackData).then(successCallback, errorCallback);
    ...
    function successCallback(data) {
      ...
      if (data.data === "OK") {
        ...
        db.transaction(function (tx) {
          ...
          tx.executeSql("DELETE FROM security", [], onDeleteSuccess, onError);
        });
